...
export function throttle(fn, wait = 16) {
  // Leading-edge throttle suitable for mousemove; drops frames if busy
  let last = 0;
  let queuedArgs = null;
  let ticking = false;
...
// Mutates the <text> selection to fit within maxWidth, appending ellipsis
