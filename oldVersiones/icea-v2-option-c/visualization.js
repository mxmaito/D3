...
export function visualizeData({ container, data, columns = VIZ_COLUMNS, title = 'Line Chart' }) {
  ...
  g.attr('data-inner-height', innerHeight); // for tooltip guideline
  ...
  // 5) Resize observer — with viewBox scaling, we often don't need to reflow.
  const ro = new ResizeObserver(() => {
    // Optionally: recompute ticks based on clientWidth for better density.
  });
