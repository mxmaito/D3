...
export const VIZ_COLUMNS = [
  ...
  { key: 'Situación de su empresa', label: 'Situación de su empresa' },
  { key: 'Situación del sector agro', label: 'Situación del sector agro' },
  { key: 'Nivel General', label: 'Nivel General ICEA' },
  { key: 'Índice Condiciones Presentes', label: 'Índice de Condiciones Presentes' },
  { key: 'Índice Expectativas', label: 'Índice de Expectativas' },
];

export const COLOR = d3.scaleOrdinal()
  .range(['#DA4B14', '#FFC000', '#009689', '#00AC66', '#FF812C', '#4F81BD']);
