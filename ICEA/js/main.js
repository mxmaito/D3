// URL pública de tu Google Sheets CSV
...
function renderChart() {
  ...
  const svgNode = createVisualization();  // Llama a la visualización (devuelve SVG o null)
...
d3.csv(csvUrl).then(rawData => {
  ...
  window.preparedData = prepareData(window.data); // Prepara los datos para graficar
  console.log("[main.js] Datos preparados (preparedData):", window.preparedData);
